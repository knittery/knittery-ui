    ...
    knitted3d: (dataName = "knitted") -> this.each(->
      ...
      createModel = () ->
        ...
        updateImage = () ->
          ...
          ctx.drawImage(txt.front, 0, 0, txt.front.width, txt.front.height, 0, 0, 300, 300/txt.front.width*txt.front.height)
          ctx.drawImage(txt.back, 0, 0, txt.back.width, txt.back.height, 350, 0, 300, 300/txt.back.width*txt.back.height)
          ctx.drawImage(txt.lash, 0, 0, txt.lash.width, txt.lash.height, 700, 0, 300, 300/txt.lash.width*txt.lash.height)
        updateImage()
